...
texttop=" P L A";//[-,P L A, A B S, P E T G, N y l o n, P V B, H I P S, P E E K, T P U, P O M, P V A, P P, A S A, P C, U L T E M, R e s i n, P A, n G E N, H T, P H A, A M 1 8 0 0,A M 3 3 0 0,N G E N _ F L E X,P U R,F L 6 0 0 0]
...
{   
    ...
    translate([ w-wall,h-wall-textsize_upper,height ])
        linear_extrude(height=th,convexity = 10)
            text(filament_type,size=textsize_upper,font=fontname,halign="right",valign="baseline");  
